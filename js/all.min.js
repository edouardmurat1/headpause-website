...
var contactWP=$('#contact').waypoint(function(direction){envelopeFn();setInterval(function(){phoneFn();setTimeout(function(){envelopeFn();},1000);},2000);},{offset:'50%'});$(window).scroll(function(){navbarCollapse();});document.addEventListener("DOMContentLoaded",function(){var defaultView=(isTouchDevice())?'listWeek':'month';var locale=(lang=='fr')?'fr':'en';var calendarEl=document.getElementById('eventcalendar');var cal=new FullCalendar.Calendar(calendarEl,{locale:locale,height:'auto',contentHeight:600,editable:false,aspectRatio:1,scrollTime:'00:00',header:{left:'title',center:false,right:'prev,next'},defaultView:defaultView,eventLimit:3,hiddenDays:[0],weekends:true,events:[{title:'Méditation gratuite',description:'Groupe de méditation de pleine conscience gratuit',color:'#28B798',startTime:'18:30:00',endTime:'20:00:00',daysOfWeek:[5],startRecur:'2019-06-21',endRecur:'2019-07-27',url:'https://tinyurl.com/yxrd38hd'},{title:'Marche / Walk',description:'Marche consciente au Mont Royal / Mindful walk on Mount Royal',color:'#B76628',startTime:'18:00:00',endTime:'19:30:00',daysOfWeek:[3],startRecur:'2019-06-05',endRecur:'2019-06-27',url:'https://tinyurl.com/y2b22dgr'},{title:'Pleine Conscience 101',description:'Pleine Conscience 101: Atelier d\'introduction à la pleine conscience',color:'#A428B7',start:'2019-06-11T18:00:00',end:'2019-06-11T20:00:00',url:'https://tinyurl.com/y64fqsr7'},{title:'Mindfulness 101',description:'Mindfulness 101: Introductory workshop to mindfulness',color:'#A428B7',start:'2019-06-13T18:00:00',end:'2019-06-13T20:00:00',url:'https://tinyurl.com/y3hlp645'},{title:'Méditation en nature',description:'Groupe de méditation de pleine conscience en nature',color:'#2DB728',start:'2019-06-15T10:00:00',end:'2019-06-15T11:00:00',url:'https://tinyurl.com/yy3byab4'},{title:'Introduction FR',description:'Introduction à la pleine conscience',color:'#A428B7',start:'2019-07-04T11:30:00',end:'2019-07-04T12:30:00',url:'https://tinyurl.com/y5mabmy2'},{title:'Méditation guidée',description:'Séance de méditation de pleine conscience',color:'#2840B7',start:'2019-07-04T12:30:00',end:'2019-07-04T13:30:00',url:'https://tinyurl.com/yyc538jp'},{title:'Introduction EN',description:'Introduction to mindfulness',color:'#A428B7',start:'2019-07-05T11:30:00',end:'2019-07-05T12:30:00',url:'https://tinyurl.com/yxtytqyj'},{title:'Guided meditation',description:'Meditation session to practice mindfulness',color:'#2840B7',start:'2019-07-05T12:30:00',end:'2019-07-05T13:30:00',url:'https://tinyurl.com/yy8p6d4g'},{title:'Méditation au parc',description:'Méditation au parc, pleine conscience en nature',color:'#2DB728',startTime:'10:30:00',endTime:'11:30:00',daysOfWeek:[3,4],startRecur:'2019-06-18',endRecur:'2019-06-28',url:'https://tinyurl.com/y4yceuqz'},{title:'Programme 4-sem',description:'Programme de 4 semaines en pleine conscience',color:'#B72831',startTime:'16:15:00',endTime:'17:45:00',daysOfWeek:[4],startRecur:'2019-07-01',endRecur:'2019-08-01',url:'https://tinyurl.com/y24jvdzz'},{title:'Méditation au parc',description:'Méditation au parc, pleine conscience en nature',color:'#2DB728',startTime:'10:30:00',endTime:'11:30:00',daysOfWeek:[2,3],startRecur:'2019-07-02',endRecur:'2019-08-01',url:'https://tinyurl.com/y27u9o5c'},],eventMouseEnter:function(mouseEnterInfo){$(mouseEnterInfo.el).tooltip({title:mouseEnterInfo.event.extendedProps.description});},eventClick:function(info){if(info.event.url){info.jsEvent.preventDefault();window.open(info.event.url,"_blank");return false;}},eventPositioned:function(info){console.log(info.el);$(info.el).css('background-color',info.event.extendedProps.color);}}).render();});})(jQuery);(function($){"use strict";$('video').hover(function(){$(this).trigger('play');},function(){$(this).trigger('pause');});var leftTeamAnimated=false;var rightTeamAnimated=false;$('#corpoteam').waypoint(function(direction){if(!leftTeamAnimated){$('#corpoteam .col-lg-6:nth-child(1) samp').each(function(index){var item=$(this);setTimeout(function(){item.addClass('to-white-color');},index*500);});leftTeamAnimated=true;}},{offset:'0'});$('#corpoteam').waypoint(function(direction){if(!rightTeamAnimated){$('#corpoteam .col-lg-6:nth-child(2) samp').each(function(index){var item=$(this);setTimeout(function(){item.addClass('to-white-color');},index*500);});rightTeamAnimated=true;}},{offset:'0'});$('#servicecorpo1').click(function(){$('#servicecorpo1').toggleClass('focused');$('#servicecorpo1_details').collapse('toggle');});$('#servicecorpo2').click(function(){$('#servicecorpo2').toggleClass('focused');$('#servicecorpo2_details').collapse('toggle');});$('#servicecorpo3').click(function(){$('#servicecorpo3').toggleClass('focused');$('#servicecorpo3_details').collapse('toggle');});$('#servicecorpo1_details').on('shown.bs.collapse',function(){$('html, body').animate({scrollTop:$('#servicecorpo1').offset().top-50},1000,"easeInOutExpo");});$('#servicecorpo2_details').on('shown.bs.collapse',function(){$('html, body').animate({scrollTop:$('#servicecorpo2').offset().top-50},1000,"easeInOutExpo");});$('#servicecorpo3_details').on('shown.bs.collapse',function(){$('html, body').animate({scrollTop:$('#servicecorpo3').offset().top-50},1000,"easeInOutExpo");});var man_at_desk=Snap.select("#man-at-desk"),man=man_at_desk.select("#man"),head=man_at_desk.select("#head"),desk=man_at_desk.select("#desk"),chair=man_at_desk.select("#chair"),screen=man_at_desk.select("#screen");function flashScreen(){screen.animate({fill:'#89B829'},500,function(){screen.animate({fill:'#C9EC83'},500);});}

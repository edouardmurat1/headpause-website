...
var contactWP=$('#contact').waypoint(function(direction){envelopeFn();setInterval(function(){phoneFn();setTimeout(function(){envelopeFn();},1000);},2000);},{offset:'50%'});$(window).scroll(function(){navbarCollapse();});$('#service1_caret').click(function(){$('#service1_details').collapse('toggle');if($('#service1_caret i').hasClass("fa-caret-down")){$('#service1_caret i').removeClass("fa-caret-down");$('#service1_caret i').addClass("fa-caret-up");}else{$('#service1_caret i').removeClass("fa-caret-up");$('#service1_caret i').addClass("fa-caret-down");}});$('#service2_caret').click(function(){$('#service2_details').collapse('toggle');if($('#service2_caret i').hasClass("fa-caret-down")){$('#service2_caret i').removeClass("fa-caret-down");$('#service2_caret i').addClass("fa-caret-up");}else{$('#service2_caret i').removeClass("fa-caret-up");$('#service2_caret i').addClass("fa-caret-down");}});$('#service3_caret').click(function(){$('#service3_details').collapse('toggle');if($('#service3_caret i').hasClass("fa-caret-down")){$('#service3_caret i').removeClass("fa-caret-down");$('#service3_caret i').addClass("fa-caret-up");}else{$('#service3_caret i').removeClass("fa-caret-up");$('#service3_caret i').addClass("fa-caret-down");}});$('#meditation_thumbs-up').click(function(){$('#meditation_thumbs-down i').removeClass("active");$('#meditation_thumbs-up i').addClass("active");$('#meditation-opinion').collapse('show');$('#meditation-opinion').removeClass("bg-light-secondary");$('#meditation-opinion').addClass("bg-light-primary");$('#meditation-opinion form input:first').focus();});$('#meditation_thumbs-down').click(function(){$('#meditation_thumbs-up i').removeClass("active");$('#meditation_thumbs-down i').addClass("active");$('#meditation-opinion').collapse('show');$('#meditation-opinion').removeClass("bg-light-primary");$('#meditation-opinion').addClass("bg-light-secondary");$('#meditation-opinion form input:first').focus();});$("#meditation-opinion form").submit(function(event){var feedback=$("#meditation-opinion form input:first").val();if(feedback!=""){$.get("https://api.myjson.com/bins/dfte6",function(data,textStatus,jqXHR){data.meditation.push(feedback);$.ajax({url:"https://api.myjson.com/bins/dfte6",type:"PUT",data:JSON.stringify(data),contentType:"application/json; charset=utf-8",dataType:"json",success:function(data,textStatus,jqXHR){$("#meditation-opinion span").text("Merci!").show();}});});}else{$("#meditation-opinion span").text("Invalide").show().fadeOut(3000);}

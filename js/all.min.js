...
var contactWP=$('#contact').waypoint(function(direction){envelopeFn();setInterval(function(){phoneFn();setTimeout(function(){envelopeFn();},1000);},2000);},{offset:'50%'});$(window).scroll(function(){navbarCollapse();});$('#service1_caret').click(function(){$('#service1_details').collapse('toggle');if($('#service1_caret i').hasClass("fa-caret-down")){$('#service1_caret i').removeClass("fa-caret-down");$('#service1_caret i').addClass("fa-caret-up");}else{$('#service1_caret i').removeClass("fa-caret-up");$('#service1_caret i').addClass("fa-caret-down");}});$('#service1_details').on('shown.bs.collapse',function(){var target;if($('#service1_details').height()+50>$(window).height()){target=$('#service1_caret').offset().top-
$('#service1_caret').height()-50;}else{target=$('#service1_details').offset().top-
$(window).height()+$('#service1_details').height()+50}
if(target>$('html, body').scrollTop()){$('html, body').animate({scrollTop:target},1000,"easeInOutExpo");}});$('#service2_caret').click(function(){$('#service2_details').collapse('toggle');if($('#service2_caret i').hasClass("fa-caret-down")){$('#service2_caret i').removeClass("fa-caret-down");$('#service2_caret i').addClass("fa-caret-up");}else{$('#service2_caret i').removeClass("fa-caret-up");$('#service2_caret i').addClass("fa-caret-down");}});$('#service2_details').on('shown.bs.collapse',function(){var target;if($('#service2_details').height()+50>$(window).height()){target=$('#service2_caret').offset().top-
$('#service2_caret').height()-50;}else{target=$('#service2_details').offset().top-
$(window).height()+$('#service2_details').height()+50}
if(target>$('html, body').scrollTop()){$('html, body').animate({scrollTop:target},1000,"easeInOutExpo");}});$('#service3_caret').click(function(){$('#service3_details').collapse('toggle');if($('#service3_caret i').hasClass("fa-caret-down")){$('#service3_caret i').removeClass("fa-caret-down");$('#service3_caret i').addClass("fa-caret-up");}else{$('#service3_caret i').removeClass("fa-caret-up");$('#service3_caret i').addClass("fa-caret-down");}});$('#service3_details').on('shown.bs.collapse',function(){var target;if($('#service3_details').height()+50>$(window).height()){target=$('#service3_caret').offset().top-

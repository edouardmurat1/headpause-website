...
*
* Date: 2018-01-20T17:24Z*/(function(global,factory){"use strict";if(typeof module==="object"&&typeof module.exports==="object"){module.exports=global.document?factory(global,true):function(w){if(!w.document){throw new Error("jQuery requires a window with a document");}
...
var Sizzle=/*!* Sizzle CSS Selector Engine v2.3.3
* https://sizzlejs.com/
*
...
*
* Date: 2016-08-08*/(function(window){var i,support,Expr,getText,isXML,tokenize,compile,select,outermostContext,sortInput,hasDuplicate,setDocument,document,docElem,documentIsHTML,rbuggyQSA,rbuggyMatches,matches,contains,expando="sizzle"+1*new Date(),preferredDoc=window.document,dirruns=0,done=0,classCache=createCache(),tokenCache=createCache(),compilerCache=createCache(),sortOrder=function(a,b){if(a===b){hasDuplicate=true;}
...
return color;}
Snap.mui.red=saveColor(red);Snap.mui.pink=saveColor(pink);Snap.mui.purple=saveColor(purple);Snap.mui.deeppurple=saveColor(deeppurple);Snap.mui.indigo=saveColor(indigo);Snap.mui.blue=saveColor(blue);Snap.mui.lightblue=saveColor(lightblue);Snap.mui.cyan=saveColor(cyan);Snap.mui.teal=saveColor(teal);Snap.mui.green=saveColor(green);Snap.mui.lightgreen=saveColor(lightgreen);Snap.mui.lime=saveColor(lime);Snap.mui.yellow=saveColor(yellow);Snap.mui.amber=saveColor(amber);Snap.mui.orange=saveColor(orange);Snap.mui.deeporange=saveColor(deeporange);Snap.mui.brown=saveColor(brown);Snap.mui.grey=saveColor(grey);Snap.mui.bluegrey=saveColor(bluegrey);Snap.flat.turquoise="#1abc9c";Snap.flat.greensea="#16a085";Snap.flat.sunflower="#f1c40f";Snap.flat.orange="#f39c12";Snap.flat.emerland="#2ecc71";Snap.flat.nephritis="#27ae60";Snap.flat.carrot="#e67e22";Snap.flat.pumpkin="#d35400";Snap.flat.peterriver="#3498db";Snap.flat.belizehole="#2980b9";Snap.flat.alizarin="#e74c3c";Snap.flat.pomegranate="#c0392b";Snap.flat.amethyst="#9b59b6";Snap.flat.wisteria="#8e44ad";Snap.flat.clouds="#ecf0f1";Snap.flat.silver="#bdc3c7";Snap.flat.wetasphalt="#34495e";Snap.flat.midnightblue="#2c3e50";Snap.flat.concrete="#95a5a6";Snap.flat.asbestos="#7f8c8d";Snap.importMUIColors=function(){for(var color in Snap.mui){if(Snap.mui.hasOwnProperty(color)){window[color]=Snap.mui[color];}}};});return Snap;}));(function($){"use strict";$('.lazy').Lazy();$('a.js-scroll-trigger[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,'')==this.pathname.replace(/^\//,'')&&location.hostname==this.hostname){var target=$(this.hash);target=target.length?target:$('[name='+this.hash.slice(1)+']');if(target.length){$('html, body').animate({scrollTop:(target.offset().top-50)},1000,"easeInOutExpo");return false;}}});$("[data-share-buttons]").load("/templates/share-buttons.html",function(){var url=($(this).data("share-buttons"))?$(this).data("share-buttons"):window.location;$(this).find("a").each(function(){this.href=this.href.replace('#currentUrl',url);});});$('.js-scroll-trigger').click(function(){$('.navbar-collapse').collapse('hide');});$('.navbar-toggler').click(function(){$(".alert").alert('close');});$('body').scrollspy({target:'#mainNav',offset:57});var navbarCollapse=function(){if($("#mainNav").offset().top>100){$("#mainNav").addClass("navbar-shrink");}else{$("#mainNav").removeClass("navbar-shrink");}};navbarCollapse();var checkPopupExist=setInterval(function(){if($('#PopupSignupForm_0').length){$("iframe").contents().find("#mc-MEDITATION").val("NO");$("iframe").contents().find("#mc-LANGUAGE").val("EN");$("iframe").contents().find(".content__button input").css('font-size',"18px");if($('html').attr('lang')=='fr'){$("iframe").contents().find("#mc-LANGUAGE").val("FR");$("iframe").contents().find(".content__titleDescription span").text('Obtenez Votre Guide Gratuit Maintenant: "Comment méditer en ville?"');$("iframe").contents().find(".content__titleDescription div:eq(1)").text('Inscrivez-vous gratuitement aujourd\'hui et nous vous informerons des événements et promotions à venir.');$("iframe").contents().find("label").text('Adresse Email');$("iframe").contents().find(".content__button input").val('Obtenez-le Maintenant');$("iframe").contents().find(".modalContent__image").css("background-image","url(/media/ebook-cover-fr.png)");$("iframe").contents().find(".content__button").click(function(){var checkSuccessPopupExist=setInterval(function(){if($("iframe").contents().find(".popup-signup-success").length){$("iframe").contents().find(".popup-signup-success").text('Votre guide gratuit vous a été envoyé!');clearInterval(checkSuccessPopupExist);}},100);});}
$("iframe").contents().find("#uniqName_3_1").hide();$("iframe").contents().find("#uniqName_3_2").hide();clearInterval(checkPopupExist);}},100);var flower1={s:null,petal1:null,petal2:null,petal3:null,petal4:null,petal5:null,init:function(){var s=Snap("#flower-stage-1");Snap.load("/img/animation/flower-petal.svg",function(f){s.append(f);var petal1=s.select('[id="petal1"]');var petal2=s.select('[id="petal2"]');var petal3=s.select('[id="petal3"]');var petal4=s.select('[id="petal4"]');var petal5=s.select('[id="petal5"]');petal1.attr({fill:"#F0F8EA"});petal2.attr({fill:"#F0F8EA"});petal3.attr({fill:"#F0F8EA"});petal4.attr({fill:"#F0F8EA"});petal5.attr({fill:"#F0F8EA"});petal1.transform('s0.6');petal2.transform('s0.6');petal3.transform('s0.6');petal4.transform('s0.6');petal5.transform('s0.6');flower1.petal1=petal1;flower1.petal2=petal2;flower1.petal3=petal3;flower1.petal4=petal4;flower1.petal5=petal5;flower1.s=s;});},animate:function(){this.petal1.animate({transform:"s0.6, t6, 1, r15"},700);this.petal2.animate({transform:"s0.6, t-6, 1, r-15"},700);}};var flower2={s:null,petal1:null,petal2:null,petal3:null,petal4:null,petal5:null,init:function(){var s=Snap("#flower-stage-2");Snap.load("/img/animation/flower-petal.svg",function(f){s.append(f);var petal1=s.select('[id="petal1"]');var petal2=s.select('[id="petal2"]');var petal3=s.select('[id="petal3"]');var petal4=s.select('[id="petal4"]');var petal5=s.select('[id="petal5"]');petal1.attr({fill:"#F0F8EA"});petal2.attr({fill:"#F0F8EA"});petal3.attr({fill:"#F0F8EA"});petal4.attr({fill:"#F0F8EA"});petal5.attr({fill:"#F0F8EA"});petal1.transform('s0.6');petal2.transform('s0.6');petal3.transform('s0.6');petal4.transform('s0.6');petal5.transform('s0.6');flower2.petal1=petal1;flower2.petal2=petal2;flower2.petal3=petal3;flower2.petal4=petal4;flower2.petal5=petal5;flower2.s=s;});},animate:function(){this.petal1.animate({transform:"s0.6, t12, 5, r35"},1400);this.petal2.animate({transform:"s0.6, t-12, 5, r-35"},1400);this.petal3.animate({transform:"s0.6, t6, 1, r15"},1400);this.petal4.animate({transform:"s0.6, t-6, 1, r-15"},1400);}};var flower3={s:null,petal1:null,petal2:null,petal3:null,petal4:null,petal5:null,init:function(){var s=Snap("#flower-stage-3");Snap.load("/img/animation/flower-petal.svg",function(f){s.append(f);var petal1=s.select('[id="petal1"]');var petal2=s.select('[id="petal2"]');var petal3=s.select('[id="petal3"]');var petal4=s.select('[id="petal4"]');var petal5=s.select('[id="petal5"]');petal1.attr({fill:"#F0F8EA"});petal2.attr({fill:"#F0F8EA"});petal3.attr({fill:"#F0F8EA"});petal4.attr({fill:"#F0F8EA"});petal5.attr({fill:"#F0F8EA"});petal1.transform('s0.6');petal2.transform('s0.6');petal3.transform('s0.6');petal4.transform('s0.6');petal5.transform('s0.6');flower3.petal1=petal1;flower3.petal2=petal2;flower3.petal3=petal3;flower3.petal4=petal4;flower3.petal5=petal5;flower3.s=s;});},animate:function(){this.petal1.animate({transform:"s0.6, t17, 7, r45"},2000);this.petal2.animate({transform:"s0.6, t-17, 7, r-45"},2000);this.petal3.animate({transform:"s0.6, t10, 2, r25"},2000);this.petal4.animate({transform:"s0.6, t-10, 2, r-25"},2000);}};flower1.init();flower2.init();flower3.init();var aboutAnimated=false;var aboutWP=$('#about').waypoint(function(direction){if(!aboutAnimated){$('#about samp').each(function(index){var item=$(this);setTimeout(function(){item.addClass('to-primary-color');},index*500);});aboutAnimated=true;}},{offset:'50%'});var flower1Animated=false;var flower2Animated=false;var flower3Animated=false;var flower1WP=$('#flower-stage-1').waypoint(function(direction){if(!flower1Animated){flower1.animate();flower1Animated=true;}},{offset:'50%'});var flower2WP=$('#flower-stage-2').waypoint(function(direction){if(!flower2Animated){flower2.animate();flower2Animated=true;}},{offset:'50%'});var flower3WP=$('#flower-stage-3').waypoint(function(direction){if(!flower3Animated){flower3.animate();flower3Animated=true;}},{offset:'50%'});var leftTeamAnimated=false;var rightTeamAnimated=false;$('#team').waypoint(function(direction){if(!leftTeamAnimated){$('#team .col-lg-6:nth-child(1) samp').each(function(index){var item=$(this);setTimeout(function(){item.addClass('to-secondary-color');},index*500);});leftTeamAnimated=true;}},{offset:'0'});$('#team').waypoint(function(direction){if(!rightTeamAnimated){$('#team .col-lg-6:nth-child(2) samp').each(function(index){var item=$(this);setTimeout(function(){item.addClass('to-secondary-color');},index*500);});rightTeamAnimated=true;}},{offset:'0'});var testimoniesAnimated=false;var testimoniesWP=$('#testimonies').waypoint(function(direction){if(!testimoniesAnimated){$("#testimony1").addClass("slide-right");setTimeout(function(){$("#testimony2").addClass("slide-right");},250);setTimeout(function(){$("#testimony3").addClass("slide-right");},500);setTimeout(function(){$("#testimony4").addClass("slide-right");},750);setTimeout(function(){$("#testimony5").addClass("slide-right");},1000);testimoniesAnimated=true;}},{offset:'25%'});var envelopeFn=function(){$('#email').removeClass("fa-envelope");$('#email').addClass("fa-envelope-open");setTimeout(function(){$('#email').removeClass("fa-envelope-open");$('#email').addClass("fa-envelope");},1000);}
var phoneFn=function(){$('.fa-phone').addClass("shake");setTimeout(function(){$('.fa-phone').removeClass("shake");},1000);}
var contactWP=$('#contact').waypoint(function(direction){envelopeFn();setInterval(function(){phoneFn();setTimeout(function(){envelopeFn();},1000);},2000);},{offset:'50%'});$(window).scroll(function(){navbarCollapse();});$('#service1_caret').click(function(){$('#service1_details').collapse('toggle');if($('#service1_caret i').hasClass("fa-caret-down")){$('#service1_caret i').removeClass("fa-caret-down");$('#service1_caret i').addClass("fa-caret-up");}else{$('#service1_caret i').removeClass("fa-caret-up");$('#service1_caret i').addClass("fa-caret-down");}});$('#service1_details').on('shown.bs.collapse',function(){var target;console.lo
if($('#service1_details').height()+100>$(window).height()){target=$('#service1_caret').offset().top-
$('#service1_caret').height()-50;}else{target=$('#service1_details').offset().top-
$(window).height()+$('#service1_details').height()+50}
if(target>$('html, body').scrollTop()){$('html, body').animate({scrollTop:target},1000,"easeInOutExpo");}});$('#service1_details').on('hidden.bs.collapse',function(){$('html, body').animate({scrollTop:$('#service1_details').closest('section').offset().top},1000,"easeInOutExpo");});$('#service2_caret').click(function(){$('#service2_details').collapse('toggle');if($('#service2_caret i').hasClass("fa-caret-down")){$('#service2_caret i').removeClass("fa-caret-down");$('#service2_caret i').addClass("fa-caret-up");}else{$('#service2_caret i').removeClass("fa-caret-up");$('#service2_caret i').addClass("fa-caret-down");}});$('#service2_details').on('shown.bs.collapse',function(){var target;if($('#service2_details').height()+100>$(window).height()){target=$('#service2_caret').offset().top-
$('#service2_caret').height()-50;}else{target=$('#service2_details').offset().top-
$(window).height()+$('#service2_details').height()+50}
if(target>$('html, body').scrollTop()){$('html, body').animate({scrollTop:target},1000,"easeInOutExpo");}});$('#service2_details').on('hidden.bs.collapse',function(){$('html, body').animate({scrollTop:$('#service2_details').closest('section').offset().top},1000,"easeInOutExpo");});$('#service3_caret').click(function(){$('#service3_details').collapse('toggle');if($('#service3_caret i').hasClass("fa-caret-down")){$('#service3_caret i').removeClass("fa-caret-down");$('#service3_caret i').addClass("fa-caret-up");}else{$('#service3_caret i').removeClass("fa-caret-up");$('#service3_caret i').addClass("fa-caret-down");}});$('#service3_details').on('shown.bs.collapse',function(){var target;if($('#service3_details').height()+100>$(window).height()){target=$('#service3_caret').offset().top-
$('#service3_caret').height()-50;}else{target=$('#service3_details').offset().top-
$(window).height()+$('#service3_details').height()+50}
if(target>$('html, body').scrollTop()){$('html, body').animate({scrollTop:target},1000,"easeInOutExpo");}});$('#service3_details').on('hidden.bs.collapse',function(){$('html, body').animate({scrollTop:$('#service3_details').closest('section').offset().top},1000,"easeInOutExpo");});$('#meditation_thumbs-up').click(function(){$('#meditation_thumbs-down i').removeClass("active");$('#meditation_thumbs-up i').addClass("active");$('#meditation-opinion').collapse('show');$('#meditation-opinion').removeClass("bg-light-secondary");$('#meditation-opinion').addClass("bg-light-primary");$('#meditation-opinion form input:first').focus();});$('#meditation_thumbs-down').click(function(){$('#meditation_thumbs-up i').removeClass("active");$('#meditation_thumbs-down i').addClass("active");$('#meditation-opinion').collapse('show');$('#meditation-opinion').removeClass("bg-light-primary");$('#meditation-opinion').addClass("bg-light-secondary");$('#meditation-opinion form input:first').focus();});$("#meditation-opinion form").submit(function(event){var feedback=$("#meditation-opinion form input:first").val();if(feedback!=""){$.get("https://api.myjson.com/bins/dfte6",function(data,textStatus,jqXHR){data.meditation.push(feedback);$.ajax({url:"https://api.myjson.com/bins/dfte6",type:"PUT",data:JSON.stringify(data),contentType:"application/json; charset=utf-8",dataType:"json",success:function(data,textStatus,jqXHR){$("#meditation-opinion span").text("Merci!").show();}});});}else{$("#meditation-opinion span").text("Invalide").show().fadeOut(3000);}
event.preventDefault();});$('#workshop_thumbs-up').click(function(){$('#workshop_thumbs-down i').removeClass("active");$('#workshop_thumbs-up i').addClass("active");$('#workshop-opinion').collapse('show');$('#workshop-opinion').removeClass("bg-light-secondary");$('#workshop-opinion').addClass("bg-light-primary");$('#workshop-opinion form input:first').focus();});$('#workshop_thumbs-down').click(function(){$('#workshop_thumbs-up i').removeClass("active");$('#workshop_thumbs-down i').addClass("active");$('#workshop-opinion').collapse('show');$('#workshop-opinion').removeClass("bg-light-primary");$('#workshop-opinion').addClass("bg-light-secondary");$('#workshop-opinion form input:first').focus();});$("#workshop-opinion form").submit(function(event){var feedback=$("#workshop-opinion form input:first").val();if(feedback!=""){$.get("https://api.myjson.com/bins/dfte6",function(data,textStatus,jqXHR){data.workshop.push(feedback);$.ajax({url:"https://api.myjson.com/bins/dfte6",type:"PUT",data:JSON.stringify(data),contentType:"application/json; charset=utf-8",dataType:"json",success:function(data,textStatus,jqXHR){$("#workshop-opinion span").text("Merci!").show();}});});}else{$("#workshop-opinion span").text("Invalide").show().fadeOut(3000);}
event.preventDefault();});$('#mindfulday_thumbs-up').click(function(){$('#mindfulday_thumbs-down i').removeClass("active");$('#mindfulday_thumbs-up i').addClass("active");$('#mindfulday-opinion').collapse('show');$('#mindfulday-opinion').removeClass("bg-light-secondary");$('#mindfulday-opinion').addClass("bg-light-primary");$('#mindfulday-opinion form input:first').focus();});$('#mindfulday_thumbs-down').click(function(){$('#mindfulday_thumbs-up i').removeClass("active");$('#mindfulday_thumbs-down i').addClass("active");$('#mindfulday-opinion').collapse('show');$('#mindfulday-opinion').removeClass("bg-light-primary");$('#mindfulday-opinion').addClass("bg-light-secondary");$('#mindfulday-opinion form input:first').focus();});$("#mindfulday-opinion form").submit(function(event){var feedback=$("#mindfulday-opinion form input:first").val();if(feedback!=""){$.get("https://api.myjson.com/bins/dfte6",function(data,textStatus,jqXHR){data.mindfulday.push(feedback);$.ajax({url:"https://api.myjson.com/bins/dfte6",type:"PUT",data:JSON.stringify(data),contentType:"application/json; charset=utf-8",dataType:"json",success:function(data,textStatus,jqXHR){$("#mindfulday-opinion span").text("Merci!").show();}});});}else{$("#mindfulday-opinion span").text("Invalide").show().fadeOut(3000);}
event.preventDefault();});})(jQuery);(function($){"use strict";$('video').hover(function(){$(this).trigger('play');},function(){$(this).trigger('pause');});var leftTeamAnimated=false;var rightTeamAnimated=false;$('#corpoteam').waypoint(function(direction){if(!leftTeamAnimated){$('#corpoteam .col-lg-6:nth-child(1) samp').each(function(index){var item=$(this);setTimeout(function(){item.addClass('to-white-color');},index*500);});leftTeamAnimated=true;}},{offset:'0'});$('#corpoteam').waypoint(function(direction){if(!rightTeamAnimated){$('#corpoteam .col-lg-6:nth-child(2) samp').each(function(index){var item=$(this);setTimeout(function(){item.addClass('to-white-color');},index*500);});rightTeamAnimated=true;}},{offset:'0'});$('#servicecorpo1').click(function(){$('#servicecorpo1').toggleClass('focused');$('#servicecorpo1_details').collapse('toggle');});$('#servicecorpo2').click(function(){$('#servicecorpo2').toggleClass('focused');$('#servicecorpo2_details').collapse('toggle');});$('#servicecorpo3').click(function(){$('#servicecorpo3').toggleClass('focused');$('#servicecorpo3_details').collapse('toggle');});$('#servicecorpo4').click(function(){$('#servicecorpo4').toggleClass('focused');$('#servicecorpo4_details').collapse('toggle');});$('#servicecorpo5').click(function(){$('#servicecorpo5').toggleClass('focused');$('#servicecorpo5_details').collapse('toggle');});$('#servicecorpo6').click(function(){$('#servicecorpo6').toggleClass('focused');$('#servicecorpo6_details').collapse('toggle');});$('#servicecorpo1_details').on('shown.bs.collapse',function(){$('html, body').animate({scrollTop:$('#servicecorpo1').offset().top-50},1000,"easeInOutExpo");});$('#servicecorpo2_details').on('shown.bs.collapse',function(){$('html, body').animate({scrollTop:$('#servicecorpo2').offset().top-50},1000,"easeInOutExpo");});$('#servicecorpo3_details').on('shown.bs.collapse',function(){$('html, body').animate({scrollTop:$('#servicecorpo3').offset().top-50},1000,"easeInOutExpo");});$('#servicecorpo4_details').on('shown.bs.collapse',function(){$('html, body').animate({scrollTop:$('#servicecorpo4').offset().top-50},1000,"easeInOutExpo");});$('#servicecorpo5_details').on('shown.bs.collapse',function(){$('html, body').animate({scrollTop:$('#servicecorpo5').offset().top-50},1000,"easeInOutExpo");});$('#servicecorpo6_details').on('shown.bs.collapse',function(){$('html, body').animate({scrollTop:$('#servicecorpo6').offset().top-50},1000,"easeInOutExpo");});$('#servicecorpo4_details').on('hidden.bs.collapse',function(){$('html, body').animate({scrollTop:$('#servicecorpo1_details').closest('section').offset().top},1000,"easeInOutExpo");});$('#servicecorpo5_details').on('hidden.bs.collapse',function(){$('html, body').animate({scrollTop:$('#servicecorpo1_details').closest('section').offset().top},1000,"easeInOutExpo");});$('#servicecorpo6_details').on('hidden.bs.collapse',function(){$('html, body').animate({scrollTop:$('#servicecorpo1_details').closest('section').offset().top},1000,"easeInOutExpo");});var man_at_desk=Snap.select("#man-at-desk"),man=man_at_desk.select("#man"),head=man_at_desk.select("#head"),desk=man_at_desk.select("#desk"),chair=man_at_desk.select("#chair"),screen=man_at_desk.select("#screen");function flashScreen(){screen.animate({fill:'#89B829'},500,function(){screen.animate({fill:'#C9EC83'},500);});}
function rotateHead(){head.animate({transform:'r5'},1000,mina.ease,function(){head.animate({transform:'r-5'},1000,mina.ease);});}
setInterval(flashScreen,2000);setInterval(rotateHead,2000);var man_meditating=Snap.select("#man-meditating"),head_2=man_meditating.select("#head"),chest=man_meditating.select("#chest");function scaleChest(){chest.animate({transform:'s1.03'},1000,function(){chest.animate({transform:'s1'},1000);});}
function moveHead(){head_2.animate({cy:'26.5'},1000,mina.ease,function(){head_2.animate({cy:'27'},1000,mina.ease);});}
setInterval(scaleChest,2000);setInterval(moveHead,2000);var bubbles1=Snap.select('#bubbles1');$("#bubbles1").width($("#man-at-desk").width());$("#bubbles1").height($('#man-at-desk').position().top-$('#problem').position().top);var bubbles1_width=$("#bubbles1").width();var bubbles1_height=$("#bubbles1").height();$('#bubbles1').css("transform",'translate(0px,-'+bubbles1_height+'px)');function addBubble1(){var bubble=bubbles1.circle(45+Math.random()*(bubbles1_width-90),bubbles1_height-25,20);var images=['thumbs-down','sad','angry'];var image=images[Math.floor(Math.random()*images.length)];bubble.attr({fill:"url(#"+image+"-image)"});bubble.transform('s0');var liftBubble=function(){bubble.animate({cy:$('#bubbles1').position().bottom},5000,mina.easeout,reduceBubble);}
var reduceBubble=function(){bubble.animate({transform:'s0'},200,mina.easeout,killBubble);}
var killBubble=function(){bubble.remove();}
bubble.animate({transform:'s1'},200,mina.easeout,liftBubble);var x=parseFloat(bubble.attr("cx"));var xOffset=10;var swayBubble=function(){xOffset=-xOffset;x=x+xOffset;bubble.animate({cx:x},1000,mina.easeinout,swayBubble);}
swayBubble();}
var bubbles1Appearing=false;var bubbles1SummonSpeed=3;var startBubbles1Timeout=function(){if(bubbles1Appearing){addBubble1();setTimeout(startBubbles1Timeout,600*bubbles1SummonSpeed+Math.random()*700);if(bubbles1SummonSpeed>1){bubbles1SummonSpeed-=1;}}}
$('#problem').waypoint(function(direction){if(!bubbles1Appearing&&direction=="down"){bubbles1Appearing=true;startBubbles1Timeout();}},{offset:'30%'});$('#problem').waypoint(function(direction){if(!bubbles1Appearing&&direction=="up"){bubbles1Appearing=true;startBubbles1Timeout();}},{offset:'-10%'});$('#problem').waypoint(function(direction){if(direction=="down"){bubbles1Appearing=false;}},{offset:'-50%'})
$('#problem').waypoint(function(direction){if(direction=="up"){bubbles1Appearing=false;}},{offset:'20%'})
var bubbles2=Snap.select('#bubbles2');$("#bubbles2").width($("#man-meditating").width());$("#bubbles2").height($('#man-meditating').position().top-$('#solution').position().top);var bubbles2_width=$("#bubbles2").width();var bubbles2_height=$("#bubbles2").height();$('#bubbles2').css("transform",'translate(0px,-'+bubbles2_height+'px)');function addBubble2(){var bubble=bubbles2.circle(45+Math.random()*(bubbles2_width-90),bubbles2_height-25,20);var images=['like','like','love','love','haha'];var image=images[Math.floor(Math.random()*images.length)];bubble.attr({fill:"url(#"+image+"-image)"});bubble.transform('s0');var liftBubble=function(){bubble.animate({cy:$('#bubbles2').offset().bottom+20},5000,mina.easeout,reduceBubble);}
var reduceBubble=function(){bubble.animate({transform:'s0'},200,mina.easeout,killBubble);}
var killBubble=function(){bubble.remove();}
bubble.animate({transform:'s1'},200,mina.easeout,liftBubble);var x=parseFloat(bubble.attr("cx"));var xOffset=10;var swayBubble=function(){xOffset=-xOffset;x=x+xOffset;bubble.animate({cx:x},1000,mina.easeinout,swayBubble);}
swayBubble();}
var bubbles2Appearing=false;var bubbles2SummonSpeed=1;var startBubbles2Timeout=function(){if(bubbles2Appearing){addBubble2();setTimeout(startBubbles2Timeout,600*bubbles2SummonSpeed+Math.random()*700);if(bubbles2SummonSpeed<3){bubbles2SummonSpeed+=1;}}}
$('#solution').waypoint(function(direction){if(!bubbles2Appearing&&direction=="down"){bubbles2Appearing=true;startBubbles2Timeout();}},{offset:'30%'});$('#solution').waypoint(function(direction){if(!bubbles2Appearing&&direction=="up"){bubbles2Appearing=true;startBubbles2Timeout();}},{offset:'-10%'});$('#solution').waypoint(function(direction){if(direction=="down"){bubbles2Appearing=false;}},{offset:'-50%'})
$('#solution').waypoint(function(direction){if(direction=="up"){bubbles2Appearing=false;}},{offset:'20%'})
console.log(document.documentElement.lang);if(document.documentElement.lang=="fr"){console.log("what");window.odometerOptions={format:'(ddd),dd',duration:2000,};}else if(document.documentElement.lang=="en"){console.log("whaaaaat");window.odometerOptions={format:'( ddd).dd',duration:2000,};}
$('#odometer-1').waypoint(function(direction){$('#odometer-1').html('55.4');},{offset:'90%'});$('#odometer-2').waypoint(function(direction){$('#odometer-2').html('2000');},{offset:'90%'});$('#odometer-3').waypoint(function(direction){$('#odometer-3').html('51');},{offset:'92%'});$('#odometer-4').waypoint(function(direction){$('#odometer-4').html('22');},{offset:'90%'});$('#odometer-5').waypoint(function(direction){$('#odometer-5').html('1100');},{offset:'90%'});$('#odometer-6').waypoint(function(direction){$('#odometer-6').html('3000');},{offset:'90%'});})(jQuery);